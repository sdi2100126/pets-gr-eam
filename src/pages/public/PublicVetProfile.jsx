...
function PublicVetProfile({ user, onLogout }) {
  ...
  return (
    <div className="app-container">
      ...
      <div className="public-content">
        <div className="breadcrumbs">
          Αρχική / Για Όλους / Προφίλ Κτηνιάτρου
        </div>
    ...
    <th key={day[0]}>{day[0]}</th>
      ...
      <div className="login-prompt">
        <p>Για να κλείσετε ραντεβού με αυτόν τον κτηνίατρο, παρακαλούμε συνδεθείτε στην πλατφόρμα.</p>
...
export default PublicVetProfile;